@Sprint4
#Author:Ayushi Godhani
Feature: NGF_51 Personalized New Graduate Financial Guidance
  ...
  Scenario Outline: User should not be able to click on submit without entering loan amount fileld
    Given User should be logged in and see the homepage
    And User click on Finwise Module
    And User click on Explore Financial Advisor button
    And User click on launch button

...
public class Hooks extends BrowserUtilities {
	...
	/*
	 * @After public static void resetDriverAfterTestRuns() {
	 * driverUtilities.resetDriver(); if (restAssuredUtilities != null) {
	 * restAssuredUtilities.resetUtilities(); }
	 * 
	 * }
	 * 
	 * 
	 * @After public void resetDriverAfterTestRuns() { if (driver != null) {
	 * System.out.println("Resetting WebDriver..."); driver.quit(); // Ensure the
	 * driver quits here driver = null; // Reset to null to avoid any further usage
	 * } if (driverUtilities != null) { driverUtilities.resetDriver(); } if
	 * (restAssuredUtilities != null) { restAssuredUtilities.resetUtilities(); }
	 * 
	 * 
	 * } /*
	 * 
	 * @AfterStep public static void screenshotAndWaitAfterStep(Scenario sc) throws
	 * IOException { BrowserUtilities.sleep(0.5);
	 * 
	 * TakesScreenshot scrShot = ((TakesScreenshot) driver); byte[] screenshot =
	 * scrShot.getScreenshotAs(OutputType.BYTES); sc.attach(screenshot, "image/png",
	 * "Test step is finished"); }
	 */

	/*
	 * @AfterAll public static void tearDown() { driver.quit(); }
	 */
